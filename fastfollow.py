...
slow_print (" \x1b[1;31m Loading PLEASE WAIT ... ", delay= 0.01)
slow_print (" \x1b[1;31m Loading FOR FOLLOWERS ONLY ... ", delay= 0.02)
...
def main():
    ...
    print(f''' {W}│{B}  [02] {W}AUTO{R} FOLLOW                  {white}-  {yellow}[Page & Normal Account]  {W}      │''')
    print(f'''{W} └──────────────────────────────────────────────────────────────────────┘''')
    linex()
