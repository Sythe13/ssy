...
slow_print("'\x1b[1;94m'Welcome to Tezuka Uy  Tools ", delay=0.01)
...
def count_lines_in_files(*file_paths):
    for i, file_path in enumerate(file_paths, start=1):
        try:
            ...
            if i == 1: 
                print(f'''\t\t{P}        ┃ {P} FRA ACCOUNT {R}: {green}{total_lines} {P} ┃''')
            elif i == 2:
                print(f'''\t\t{P}        ┃ {P} RPA ACCOUNT {R}: {green}{total_lines} {P} ┃''')
            elif i == 3:
                print(f'''\t\t{P}        ┃ {P} FRA PAGES   {R}: {green}{total_lines}  {P}┃''')
            elif i == 4:
                print(f'''\t\t{P}        ┃{P}  RPA PAGES   {R}: {green}{total_lines}  {P}┃''')
            elif i == 5:
            	print(f'''\t\t{P} ━━━━━━━━━━━━━━━ ''')
...
def main():
    ...
    print(f'''\t\t{P}    ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ ''')
    print(f'''\t\t{P}    ┃  {B}     TOOL OVERVIEW    {P}    ┃''')
    print(f''''\t\t{P}    ┗━━━┏━━━━━━━━━━━━━━━━━━━┓━━━━┛''')
    count_lines_in_files(path_file1, path_file2, path_file3, path_file4)
   
    linex()
    print(f'''{P}                    ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ ''')
    print(f'''{P} ┏━━━━━━━━━━━━━━━━━━┃  {B}     TOOL SERVICES   {P}     ┃━━━━━━━━━━━━━━━━━━━┓''')
    print(f' {P}┃                  ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛       {P}            ┃''')
    print(f'''{P} ┃{R}  [01] {G}START TOOL                   {white}-  {red}[Log in account]       {P}     ┃''')
    print(f''' {P}┃{R}  [02] {Y}AUTO REACT W/O {G}CARE          {white}-  {red}[Page & Normal Account]   {P}  ┃ ''')
    print(f'''{P} ┃{R}  [03] {Y}AUTO REACT WITH{G} CARE         {white}-  {red}[Normal Account Only]     {P}  ┃''')
    print(f'''{P} ┃{R}  [04] {Y}AUTO REACT TO {G}COMMENT        {white}-  {red}[Page & Normal Account]   {P}  ┃''')
    print(f'''{P} ┃{R}  [05] {Y}AUTO REACT TO {G}DP & COVER     {white}-  {red}[Page & Normal Account]    {P} ┃''')
    print(f'''{P} ┃{R}  [06] {Y}AUTO REACT TO {G}REELS          {white}-  {red}[Page & Normal Account]    {P} ┃''')
    print(f''' {P}┃{R}  [07] {Y}AUTO{G} FOLLOW                  {white}-  {red}[Page & Normal Account]  {P}   ┃''')
    print(f'''{P} ┃{R}  [08] {Y}AUTO COMMENT TO{G} POST         {white}-  {red}[Page & Normal Account]  {P}   ┃''')
    print(f''' {P}┃{R}  [09] {Y}AUTO COMMENT TO{G} REELS        {white}-  {red}[Page & Normal Account]  {P}   ┃''')
    print(f'''{P} ┃{R}  [10] {Y}AUTO COMMENT TO{G} DP           {white}-  {red}[Page & Normal Account]    {P} ┃''')
    print(f'''{P} ┃{R}  [11] {Y}REPLY TO {G}COMMENT             {white}-  {red}[Page & Normal Account]   {P}  ┃''')
    print(f''' {P}┃{R}  [12] {Y}AUTO SHARE {G}V2                {white}-  {red}[Normal Account Only]    {P}   ┃''')
    print(f'''{P} ┃{R}  [13] {Y}AUTO GROUP {G}JOIN              {white}-  {red}[Facebook Page Only]  {P}      ┃''')
    print(f'''{P} ┃{R}  [14] {Y}LIKE & FOLLOW{G} PAGE           {white}-  {red}[Facebook Page Only]    {P}    ┃''')
    print(f''' {P}┃{R}  [15] {Y}STORED PAGES AND ACCOUNT     {white}-  {red}[Page & Normal Account]  {P}   ┃''')
    print(f''' {P}┃{R}  [16] {Y}RESET {G}TOOL                   {white}-  {red}[ Restarting ]         {P}     ┃''')
    print(f'''{P} ┃{R}  [00] {Y}EXIT                         {white}- {red} [Exit]               {P}       ┃''')
    print(f'''{P} ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛''')
    line()
